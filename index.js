...
function checkCollision(rock) {
  ...
  if (top > 360) {
    ...
    /** 
    (rockRightEdge >= dodgerLeftEdge && rockLeftEdge <= dodgerLeftEdge) || ( rockRightEdge <= dodgerRightEdge && rockLeftEdge >= dodgerLeftEdge ) || (rockLeftEdge <= dodgerRightEdge && rockRightEdge >= dodgerRightEdge ) 
    */
